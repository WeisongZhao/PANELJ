...
* are based on it.
* 
* Reference: [1]. Weisong Zhao, et al. "Towards real-time super-resolution: fluctuation via 
polarization modulation." Optics Letters (2019).
*/

/*
 * Copyright 2019 Weisong Zhao.
 * 
 * This file is part of POFI Analyze plugin (POFI).
 * 
