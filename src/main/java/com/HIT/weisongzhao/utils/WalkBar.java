...
public class WalkBar extends JToolBar implements ActionListener {
	...
	private String[] about = { "About", "Version", "Description", "Author", "Harbin Institute of Technology", "2020",
	...
	public void progress(String msg, int value) {
		...
		String t = " [" + (elapsedTime > 3000.0D ? Math.round(elapsedTime / 10.0D) / 100.0D + "s."
				: new StringBuilder(String.valueOf(elapsedTime)).append("ms").toString()) + "]";
	...
	public void fillAbout(String name, String version, String description, String author, String organisation,
	...
	public void showAbout() {
		final JFrame frame = new JFrame("PANEL " + this.about[0]);
		...
		pane.setText("<html><head><title>" + this.about[0] + "</title>" + getStyle() + "</head><body>"
				+ (this.about[0] == "" ? ""
						: new StringBuilder("<p class=\"name\">").append(this.about[0]).append("</p>").toString())
				+ (this.about[1] == "" ? ""
						: new StringBuilder("<p class=\"vers\">").append(this.about[1]).append("</p>").toString())
				+ (this.about[2] == "" ? ""
						: new StringBuilder("<p class=\"desc\">").append(this.about[2]).append("</p><hr>").toString())
				+ (this.about[3] == "" ? ""
						: new StringBuilder("<p class=\"auth\">").append(this.about[3]).append("</p>").toString())
				+ (this.about[4] == "" ? ""
						: new StringBuilder("<p class=\"orga\">").append(this.about[4]).append("</p>").toString())
				+ (this.about[5] == "" ? ""
						: new StringBuilder("<p class=\"date\">").append(this.about[5]).append("</p>").toString())
				+ (this.about[6] == "" ? ""
						: new StringBuilder("<p class=\"more\">").append(this.about[6]).append("</p>").toString())
				+ "</html>");
	...
	public void showHelp() {
		...
		pane.setText("<html><head><title>" + this.about[0] + "</title>" + getStyle() + "</head><body>"
				...
				+ (this.about[1] == "" ? ""
						: new StringBuilder("<p class=\"vers\">").append(this.about[1]).append("</p>").toString())
				+ (this.about[2] == "" ? ""
						: new StringBuilder("<p class=\"desc\">").append(this.about[2]).append("</p>").toString())
				+ "<hr><p class=\"help\">" + this.help + "</p>" + "</html>");
